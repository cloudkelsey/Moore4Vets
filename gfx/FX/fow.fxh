PixelShader = 
{
	...
	static const float HEIGHT_FOG_END = 0.0;
	static const float HEIGHT_FOG_START = 0.0;
	static const float HEIGHT_FOG_POW = 3.5;
	static const float HEIGHT_FOG_MAX = 0.0;
	
	static const float FOW_TRANSPARENCY_MIN = 1.0;
	static const float FOW_TRANSPARENCY_MAX = 1.0;
