...
NDefines.NDiplomacy.VOLUNTEERS_PER_COUNTRY_ARMY = 1 -- unsorted
NDefines.NDiplomacy.VOLUNTEERS_DIVISIONS_REQUIRED = 0 -- unsorted
...
NDefines.NProduction.MIN_POSSIBLE_TRAINING_MANPOWER = 1000000 -- unsorted
NDefines.NProduction.MIN_LICENSE_ACTIVE_DAYS = 0 -- unsorted
...
NDefines.NMilitary.PROMOTE_LEADER_CP_COST = 15 -- unsorted
