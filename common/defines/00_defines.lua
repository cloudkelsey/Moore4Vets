...
NAI = {
	...
	DIVISION_UPGRADE_MIN_XP = 0,				-- Minimum XP before attempting to upgrade a division template.
	DIVISION_CREATE_MIN_XP = 0,				-- Minimum XP before attempting to create a fresh new division template.
